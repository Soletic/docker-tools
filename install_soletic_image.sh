...
repos=("hosting-docker-ubuntu" "hosting-docker-phpserver" "hosting-docker-mysql" "hosting-docker-phpmyadmin" "hosting-docker-sshd" "hosting-docker-ssh-chroot" "hosting-docker-ssh-webvps")
