...
repos=("hosting-docker-http-proxy" "hosting-docker-ubuntu" "hosting-docker-mailer-webvps" "hosting-docker-phpserver" "hosting-docker-mysql" "hosting-docker-phpmyadmin" "hosting-docker-sshd" "hosting-docker-ssh-chroot" "hosting-docker-ssh-webvps" "hosting-docker-wikitten" "hosting-docker-redmine")
